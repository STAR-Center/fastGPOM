...
def feed_input():
    ...
    file_name = '/home/kuang/software/Robotics/mcmc/catkin_ws/src/fun-gpom/data_set/stdr/stdr_robocup.bag'
...
if __name__ == '__main__':
    ...
    for feeds in gen:
        ...
        count += 1
    print('\nsave map!')
    scipy.io.savemat("/home/kuang/robocup.map",{"prob_map":gp_map.map})
