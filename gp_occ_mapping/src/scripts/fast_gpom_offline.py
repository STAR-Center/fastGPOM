...
def feed_input():
    ...
    file_name = '/home/kuanghf/workspace/Robotics/mcmc/final/catkin_ws/src/fun-gpom/data_set/stdr/stdr_data.bag'
...
#plot_current_map()
    ...
    print('\nsave map!')
    scipy.io.savemat("/home/kuang/stdr.map",{"prob_map":gp_map.map})
